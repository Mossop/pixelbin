...
def build_error_response(code, message_args=None, detail=None, status=status.HTTP_400_BAD_REQUEST):
    return Response({
        'code': code,
        'args': message_args,
        'detail': detail,
...
class ApiException(Exception):
    def __init__(self, code, message_args=None, detail=None, status=status.HTTP_400_BAD_REQUEST):
        super().__init__()
        self.code = code
