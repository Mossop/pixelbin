# Generated by Django 2.2.5 on 2019-11-09 16:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='tag',
            constraint=api.constraints.UniqueWithLookupsConstraint(fields=('catalog',), lookups=[django.db.models.functions.text.Lower(django.db.models.expressions.F('name'))], name='unique_tag_name'),
        ),
        migrations.AddConstraint(
            model_name='person',
            constraint=api.constraints.UniqueWithLookupsConstraint(fields=('catalog',), lookups=[django.db.models.functions.text.Lower(django.db.models.expressions.F('fullname'))], name='unique_person_name'),
        ),
        migrations.AddConstraint(
            model_name='album',
        ...
        migrations.AddConstraint(
            model_name='album',
            constraint=api.constraints.UniqueWithLookupsConstraint(fields=('catalog', 'parent'), lookups=[django.db.models.functions.text.Lower(django.db.models.expressions.F('name'))], name='unique_album_name'),
        ),
        migrations.AddConstraint(
            model_name='access',
