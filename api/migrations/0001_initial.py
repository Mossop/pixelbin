# Generated by Django 2.2.5 on 2019-10-20 23:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(max_length=24, primary_key=True, serialize=False)),
                ('stub', models.CharField(max_length=50, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.CharField(choices=[('album', 'Album'), ('tag', 'Tag'), ('person', 'Person')], max_length=20)),
                ('operation', models.CharField(choices=[('child', 'is'), ('descendant', 'ancestor is')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('invert', models.BooleanField()),
                ('join', models.CharField(choices=[('&&', 'and'), ('||', 'or')], max_length=5)),
            ],
        ),
        migrations.CreateModel(
            name='Server',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='query', to='api.FieldQuery')),
                ('group', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='query', to='api.QueryGroup')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='queries', to='api.QueryGroup')),
            ],
        ),
        migrations.CreateModel(
            name='Person',
        ...
        migrations.AddConstraint(
            model_name='album',
            constraint=models.UniqueConstraint(fields=('catalog', 'parent', 'name'), name='unique_album_name'),
        ),
        migrations.AddConstraint(
            model_name='access',
