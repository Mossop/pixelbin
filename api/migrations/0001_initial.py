# Generated by Django 3.0.2 on 2020-04-08 16:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='tag',
            constraint=api.constraints.UniqueWithExpressionsConstraint(expressions=[django.db.models.functions.text.Lower(django.db.models.expressions.F('name'))], fields=['catalog', 'parent'], name='unique_tag_name'),
        ),
        migrations.AddConstraint(
            model_name='person',
        ...
        migrations.AddConstraint(
            model_name='album',
            constraint=api.constraints.UniqueWithExpressionsConstraint(expressions=[django.db.models.functions.text.Lower(django.db.models.expressions.F('name'))], fields=['parent'], name='unique_album_name'),
        ),
        migrations.AddConstraint(
            model_name='access',
