# Generated by Django 2.2.5 on 2019-11-02 17:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='tag',
            constraint=models.CheckConstraint(check=models.Q(lc_name=django.db.models.functions.text.Lower('name')), name='ensure_tag_lc_name_correct'),
        ),
        migrations.AddConstraint(
            model_name='tag',
            constraint=models.UniqueConstraint(fields=('catalog', 'parent', 'lc_name'), name='unique_tag_name'),
        ),
        migrations.AddConstraint(
            model_name='person',
            constraint=models.CheckConstraint(check=models.Q(lc_name=django.db.models.functions.text.Lower('full_name')), name='ensure_person_lc_name_correct'),
        ),
        migrations.AddConstraint(
            model_name='person',
        ...
        migrations.AddConstraint(
            model_name='album',
            constraint=models.CheckConstraint(check=models.Q(lc_name=django.db.models.functions.text.Lower('name')), name='ensure_album_lc_name_correct'),
        ),
        migrations.AddConstraint(
            model_name='album',
