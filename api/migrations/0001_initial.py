# Generated by Django 2.1 on 2018-09-03 06:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('include_type', models.CharField(choices=[('AND', 'And'), ('OR', 'Or')], max_length=5)),
                ('exclude_tags', models.ManyToManyField(related_name='excluded_tag_searches', to='api.Tag')),
                ('include_tags', models.ManyToManyField(related_name='included_tag_searches', to='api.Tag')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tag_searches', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='media',
