...
export declare type TableRecord<T extends Table> = TableMapping[T];
export declare function ref<T extends Table, K extends keyof TableRecord<T>>(table: T, column?: K): string;
