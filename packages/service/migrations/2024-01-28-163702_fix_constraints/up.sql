...
ALTER TABLE "alternate_file"
    ADD CONSTRAINT "foreign_media_file" FOREIGN KEY ("media_file") REFERENCES "media_file"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE "media_file"
    ADD CONSTRAINT "foreign_media_item" FOREIGN KEY (media_item) REFERENCES "media_item"(id) ON UPDATE CASCADE ON DELETE CASCADE;
