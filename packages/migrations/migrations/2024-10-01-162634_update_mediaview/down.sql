ALTER TABLE media_item ADD COLUMN updated timestamp with time zone NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
CREATE VIEW media_view AS SELECT
    ...
    media_item.catalog,
    media_item.created,
    GREATEST(media_item.updated, media_file.uploaded) AS updated,
    media_item.datetime,
    media_item.public,
    ...
    media_file_alternates.alternates
FROM
    media_item
