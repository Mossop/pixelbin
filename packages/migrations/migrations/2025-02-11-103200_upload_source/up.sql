...
ALTER TABLE "media_item" ADD COLUMN IF NOT EXISTS "source" character varying(30);
ALTER TABLE "media_item"
    ADD CONSTRAINT "foreign_source" FOREIGN KEY (source) REFERENCES "source"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
FROM
    ...
    LEFT JOIN source ON media_item.source=source.id
WHERE NOT deleted;
